  ...
  const steps: Step[] = [
    {
      ...
      desc: 'Tell us about the property, access, and services you need in a couple of minutes.',
      icon: (
    ...
    {
      title: 'We follow up',
      desc: 'A specialist confirms pricing, answers questions, and suggests visit slots that work for you.',
      icon: (
        <svg className="h-3 w-3" fill="currentColor" viewBox="0 0 20 20">
    ...
    },
    {
      ...
      desc: 'Our fully insured team completes the work and you settle up after the visit—no upfront payment needed.',
      icon: (
        <svg className="h-3 w-3" fill="currentColor" viewBox="0 0 20 20">
