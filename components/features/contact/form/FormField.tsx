...
export function FormField({ 
  ...
  return (
    <div className={cn('space-y-2', className)}>
      ...
      {/* Warning Message */}
      {hasWarning && (
        <div className="flex items-center gap-2 text-brand-red/80 text-xs">
    ...
    <input
      className={cn(
        ...
        // State-based styles
        {
          ...
          // Warning state
          'border-brand-red/50 focus:border-brand-red/60 focus:ring-brand-red/25': warning && !error && !success,
